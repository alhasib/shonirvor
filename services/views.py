...
def service_catagory(request):
    ...
    context={'form':form}
    return render(request, 'services/service_catagory.html', context)
...
def service_add(request):
    if request.method == 'POST':
        ...
        form = ServiceAddForm()
        context = {'form':form}
        return render(request,'services/service_add.html', context)
...
def catagorywise_service(request, service_catagory):
    ...
    return render(request,'services/catagorywise_service.html',context)
